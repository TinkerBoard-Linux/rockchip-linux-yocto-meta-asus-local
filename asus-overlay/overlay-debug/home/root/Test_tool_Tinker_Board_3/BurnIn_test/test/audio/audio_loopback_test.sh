...
do
    ...
    /home/root/Desktop/Test_tool/audio_test.sh 0 0 /home/root/Desktop/Test_tool/Audio/1kHz_Sinewave_mono_30s.wav &
    sleep 1
    ...
    /home/root/Desktop/Test_tool/audio_test.sh 1 8 $FILENAME
    ...
    result=$(/home/root/Desktop/Test_tool/BurnIn_test/test/audio/asus_audioAnalysis $FILENAME)
    if [ "$result" = "PASS" ]; then
        ((pass_cnt+=1))
